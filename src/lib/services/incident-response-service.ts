 ...
 *
 * Unified service for security event handling:
 * - EU Space Act incident classification, severity, NCA notification deadlines
 * - NIS2 significant incident reporting (24h/72h/30d timeline)
 * - GDPR breach notification (72h authority notification, Art. 33/34)
 *
 * Consolidates incident-response and breach-notification into a single service.
 */
...
/**
 * Unified security event type covering NIS2 incidents, GDPR breaches,
 * and EU Space Act incidents.
 */
...
/**
 * Returns the appropriate regulatory timeline for a given security event type.
 */
export function getSecurityEventTimeline(
  eventType: SecurityEvent["type"],
): SecurityEvent["timeline"] {
  switch (eventType) {
    case "nis2_incident":
      return {
        ...
        deadlines: [
          {
            ...
            description:
              "Art. 23(4)(a): Initial early warning to CSIRT/competent authority",
          },
          {
            name: "Incident Notification",
            hoursFromDetection: 72,
            description: "Art. 23(4)(b): Detailed incident notification",
          },
          {
            name: "Final Report",
            hoursFromDetection: 30 * 24,
            description:
        ...
        deadlines: [
          {
            ...
            hoursFromDetection: 72,
            description:
              "Art. 33: Notify supervisory authority within 72 hours of discovery",
          },
          {
            name: "Subject Notification",
            hoursFromDetection: 0,
            description:
              "Art. 34: Notify data subjects without undue delay when high risk to rights",
          },
        ],
      };
    case "eu_space_act_incident":
      return {
        regulation: "EU Space Act (COM(2025) 335)",
        deadlines: [
          {
            name: "Critical NCA Notification",
            hoursFromDetection: 4,
            description:
              "Art. 33-34: Critical incidents (loss of contact, debris, cyber)",
          },
          {
            name: "Standard NCA Notification",
            hoursFromDetection: 24,
            description:
              "Art. 33-34: High-severity incidents (spacecraft anomaly)",
          },
          {
            name: "Extended NCA Notification",
            hoursFromDetection: 72,
            description: "Art. 55-57: Conjunction events, regulatory breaches",
          },
        ],
      };
  }
...
// ═══════════════════════════════════════════════════════════════════════════════
// EU Space Act & NIS2 Incident Types and Constants
// ═══════════════════════════════════════════════════════════════════════════════
...
/**
 * GDPR Art. 33/34 — Breach Reporting Timeline Constants
 */
export const GDPR_REPORTING_TIMELINE = {
  /** Art. 33: Supervisory authority must be notified within 72 hours */
  authorityNotificationHours: 72,
  /** Art. 34: Data subjects notified when breach is likely to result in high risk */
  subjectNotificationCondition: "high_risk_to_rights",
} as const;
