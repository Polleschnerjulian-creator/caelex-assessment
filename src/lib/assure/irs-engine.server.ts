...
export async function computeAndSaveIRS(
  ...
  await prisma.investmentReadinessScore.create({
    data: {
      ...
      topStrengths: JSON.parse(JSON.stringify(result.topStrengths)),
      topWeaknesses: JSON.parse(JSON.stringify(result.topWeaknesses)),
      improvementPlan: JSON.parse(JSON.stringify(result.improvementPlan)),
