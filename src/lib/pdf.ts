...
function ComplianceReportDocument({ result }: { result: ComplianceResult }) {
  ...
  return createElement(
      ...
      createElement(
        ...
        createElement(
          ...
          ...[
            ...
            createElement(
              View,
              { key: i, style: styles.profileItem },
    ...
    createElement(
      ...
      createElement(
        ...
        ...result.moduleStatuses.map((mod: ModuleStatus, i: number) => {
          const colors =
            statusColors[mod.status] || statusColors.not_applicable;
          return createElement(
            View,
            { key: i, style: styles.moduleItem },
    ...
    createElement(
      ...
      ...result.checklist
        ...
        .map((item: ChecklistItem, i: number) =>
          createElement(
            View,
            { key: i, style: styles.checklistItem },
            createElement(Text, { style: styles.checklistNumber }, `${i + 1}.`),
            createElement(
              View,
              ...
              createElement(
                ...
                `Art. ${item.articles} | ${item.module.replace(/_/g, " ")}`,
              ),
            ),
          ),
        ),
...
export async function generatePDF(result: ComplianceResult): Promise<void> {
  const doc = createElement(ComplianceReportDocument, {
    result,
