...
export async function generatePDF(
  ...
  try {
    ...
    doc.setProperties({
      ...
      // Author = legal entity per /legal/impressum (sole proprietorship,
      // not a GmbH). Keep this in sync with the disclaimer text below.
    ...
    const disclaimerText = doc.splitTextToSize(
      "DISCLAIMER: This assessment is based on the EU Space Act proposal (COM(2025) 335). The EU Space Act is a legislative proposal subject to amendments during the ordinary legislative procedure. Requirements may change before final adoption. This does not constitute legal advice. Consult qualified legal counsel for definitive compliance determinations. Generated by Caelex (caelex.eu). This report is proprietary to Caelex (sole proprietorship of Julian Polleschner, Berlin — see caelex.eu/legal/impressum) and may not be redistributed or used to build competing products.",
      CONTENT_W - 8,
    );
