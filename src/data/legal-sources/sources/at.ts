...
const TREATIES_AT: LegalSource[] = [
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/1968/103",
  ...
  },
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/1980/162",
    issuing_body: "United Nations / Nationalrat",
  ...
  },
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/1980/163",
    issuing_body: "United Nations / Nationalrat",
  ...
  },
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/1984/286",
    issuing_body: "United Nations / Nationalrat",
    competent_authorities: ["AT-BMEIA"],
...
const TELECOM_AT: LegalSource[] = [
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/I/2021/190",
    issuing_body: "Nationalrat",
...
const CYBERSECURITY_AT: LegalSource[] = [
  {
    ...
    // Draft — no BGBl number assigned yet; once enacted, source_url should
    // become https://www.ris.bka.gv.at/eli/bgbl/I/<year>/<num>
    source_url: "https://www.parlament.gv.at/gegenstand/XXVIII/I",
    issuing_body: "Nationalrat",
    competent_authorities: ["AT-BMIMI"],
    relevance_level: "high",
    applicable_to: ["all"],
...
const DATA_PROTECTION_AT: LegalSource[] = [
  {
    ...
    source_url: "https://www.ris.bka.gv.at/eli/bgbl/I/1999/165",
    issuing_body: "Nationalrat",
