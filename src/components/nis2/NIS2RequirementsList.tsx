    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-white">{applicableCount}</div>
          <div className="text-xs text-white/45">of {totalCount} total</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-2.5 text-center">
          ...
          <div className="text-micro uppercase tracking-wider text-red-400/60">
            Critical
          </div>
        </div>
        <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-2.5 text-center">
          ...
          <div className="text-micro uppercase tracking-wider text-amber-400/60">
            Major
          </div>
        </div>
        <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-2.5 text-center">
          ...
          <div className="text-micro uppercase tracking-wider text-blue-400/60">
            Minor
          </div>
        </div>
      </div>
                      ...
                      {reqs.map((req) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span
                              className={`text-micro uppercase tracking-wider ${config.color} flex-shrink-0`}
                            >
                              {config.label}
                            </span>
                          </div>
