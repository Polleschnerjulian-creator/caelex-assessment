            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-caption text-emerald-400/70 bg-emerald-500/10 px-2 py-0.5 rounded">
                    {audience.code}
                  </span>
                </div>
                <h3 className="text-body-lg font-medium text-white tracking-[-0.01em] mb-2">
                  {audience.title}
                </h3>
