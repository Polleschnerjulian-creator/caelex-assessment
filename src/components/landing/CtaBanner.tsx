    ...
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <Link
            href="/contact"
            className="group relative flex flex-col justify-between bg-[#F0F1F3] rounded-sm p-10 md:p-14 min-h-[200px] md:min-h-[260px] transition-colors duration-300 hover:bg-[#E5E7EB]"
          >
          ...
          <Link
            href="/assessment"
            className="group relative flex flex-col justify-between bg-[#111827] rounded-sm p-10 md:p-14 min-h-[200px] md:min-h-[260px] transition-colors duration-300 hover:bg-[#1E293B]"
          >
