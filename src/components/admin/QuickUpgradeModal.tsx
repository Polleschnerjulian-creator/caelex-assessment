            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ...
                    <button
                      ...
                      className={`px-3 py-2.5 rounded-lg border text-body font-medium transition-all ${
                        plan === p.value
                          ? p.value === "ENTERPRISE"
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-body font-medium rounded-lg transition-colors"
                >
                  {loading ? (
