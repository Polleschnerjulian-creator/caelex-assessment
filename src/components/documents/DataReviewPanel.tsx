      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/[0.02]">
          ...
          <div className="space-y-4">
            {/* Language Selection */}
            <div>
              <label className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-white/45 mb-2">
                <Globe size={12} />
                Document Language
              </label>
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                      language === lang.code
                        ...
                        : "bg-slate-50 dark:bg-white/[0.03] text-slate-600 dark:text-white/45 border border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20"
                    }`}
                  >
                    {lang.label}
                  </button>
