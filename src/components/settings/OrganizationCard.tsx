      ...
      <div className="space-y-4">
        ...
        {hasOrg && (
          <button
            ...
            className="flex items-center gap-1.5 text-body text-slate-500 dark:text-white/45 hover:text-slate-700 dark:hover:text-white/70 transition-colors mb-2"
          >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-body font-medium transition-colors"
        >
          {isCreating ? (
            <>
            ...
            <div className="p-4 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-body text-emerald-700 dark:text-emerald-400/80 mt-1">
                    You&apos;ve been invited to join{" "}
                    <span className="font-semibold">
                      {invitationInfo.orgName}
                    </span>{" "}
                    as <span className="text-small">{invitationInfo.role}</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            {invitationInfo.emailMatch === false && (
              <div className="p-4 rounded-lg bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-body-lg font-medium text-amber-800 dark:text-amber-300">
                      Email Mismatch
                    </p>
                    <p className="text-body text-amber-700 dark:text-amber-400/80 mt-1">
      ...
      <>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <span
              className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-small font-medium ${planBadgeStyles[displayPlan] || planBadgeStyles.FREE}`}
            >
          ...
          <div>
            ...
            <span
              className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-small font-medium ${roleBadgeStyles[displayRole] || roleBadgeStyles.MEMBER}`}
            >
              {displayRole}
            </span>
          </div>
          ...
          <div>
            ...
            <p className="text-subtitle text-slate-900 dark:text-white flex items-center gap-1.5">
              <Users className="w-4 h-4 text-slate-400 dark:text-white/45" />
        ...
        <div className="mt-6 pt-6 border-t border-slate-200 dark:border-white/10 flex items-center justify-between flex-wrap gap-3">
          ...
          <button
            onClick={() => resetAndSwitchTo("create")}
            className="inline-flex items-center gap-1.5 text-body text-slate-500 dark:text-white/45 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
          >
