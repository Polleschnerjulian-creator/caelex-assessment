 ...
 *
 * Atlas V2 — Workflow Catalog (browse page).
 *
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        {visible.map((w) => (
          <button
            ...
            className="group flex flex-col gap-2 rounded-lg border border-slate-700/60 bg-slate-900/40 p-4 text-left transition-colors hover:border-emerald-500/50 hover:bg-slate-900"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="mt-1 line-clamp-2 block text-[12px] leading-snug text-slate-400">
                  {w.description}
                </span>
              </div>
            </div>
            <div className="mt-1 flex flex-wrap items-center gap-3 border-t border-slate-800 pt-2 text-[10px] text-slate-500">
