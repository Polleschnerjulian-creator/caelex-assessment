...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-title font-medium text-white mb-2">{title}</h3>

      <p className="text-body text-white/45 max-w-sm mb-6">{description}</p>
...
export function CompactEmptyState({
  ...
  return (
    ...
    >
      ...
      <p className="text-body text-white/70 mb-3">{message}</p>
      {action && (
        <button
          onClick={action.onClick}
