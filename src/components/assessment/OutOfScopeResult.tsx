...
export default function OutOfScopeResult({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h2 className="text-display-sm font-medium tracking-[-0.02em] text-white mb-3">
      ...
      {detail && (
        ...
        >
          <p className="text-body-lg text-white/45 leading-relaxed">{detail}</p>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-body text-white/45 hover:text-emerald-400 transition-colors"
        >
      ...
      >
        <p className="text-body-lg text-white/45 mb-2">
