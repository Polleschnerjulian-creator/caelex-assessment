...
> = {
  in_force: {
    ...
    dot: "bg-[var(--accent-success-soft)]0",
        ...
        <div className="relative">
          ...
          <div className="relative h-8 mb-2">
            {yearMarkers.map((m) => (
              <div
                key={m.year}
                className="absolute top-0 text-micro text-[var(--text-secondary)]"
          ...
          <div className="relative h-2 bg-[var(--surface-sunken)] rounded-full mb-4">
            ...
            {/* Current date marker */}
            <div
              className="absolute top-[-6px] w-0.5 h-[20px] bg-[var(--accent-danger)] z-20"
              style={{ left: `${nowPercent}%` }}
            >
              <div className="absolute -top-5 left-1/2 -translate-x-1/2 whitespace-nowrap text-micro text-[var(--accent-danger)] font-medium">
                Today
              </div>
            </div>
          </div>
            ...
            {phases.map((phase, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Phase dot */}
                  <div
                    className={`absolute -left-1.5 -top-1.5 w-3 h-3 rounded-full ${colors.dot} ring-2 ring-white z-10 cursor-pointer transition-transform ${
                      isHovered ? "scale-150" : ""
                    }`}
                  ...
                  <AnimatePresence>
                    {isHovered && (
                      ...
                      >
                        <p className="text-small font-medium text-[var(--text-primary)] mb-1">
                          {phase.regulation}
                        </p>
                        ...
                        {phase.supersededBy && (
                          <p className="text-micro text-[var(--accent-warning)] mt-2">
            ...
            >
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    <div className="px-3 pb-3 pt-0 border-t border-[var(--border-default)]/50">
