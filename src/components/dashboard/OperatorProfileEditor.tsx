    ...
    <div className="space-y-6">
            ...
            <div className="flex flex-col gap-2.5">
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-[var(--border-default)] text-[var(--accent-primary)] focus:ring-[var(--border-focus)]/30 bg-[var(--fill-inset)]"
                />
                    ...
                    className={`
                      ...
                      ${
                        isSelected
                          ...
                          : "bg-[var(--fill-light)] text-[var(--text-secondary)] border border-[var(--border-default)] hover:border-[var(--border-default)]"
                      }
                    `}
                  >
                    {j.label}
      ...
      <GlassCard hover={false} className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-[var(--fill-light)] border border-[var(--separator)]">
            <div
