  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] px-4">
      <div className="max-w-md w-full text-center">
        {/* Lock icon */}
        <div className="w-16 h-16 rounded-xl bg-[var(--fill-light)] border border-[var(--separator-strong)] flex items-center justify-center mx-auto mb-6">
          <Lock
            size={28}
        ...
        {/* Plan badge */}
        <div className="inline-flex items-center gap-2 bg-[var(--fill-light)] border border-[var(--separator-strong)] rounded-lg px-3 py-1.5 mb-6">
