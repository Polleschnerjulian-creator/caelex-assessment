...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  ...
  NIS2: { label: "NIS2", color: "bg-red-50 text-red-700 border-red-200" },
  EU_SPACE_ACT: {
    label: "EU Space Act",
    ...
    <div className="min-h-screen bg-[#F7F8FA] px-6 lg:px-12 py-10">
      <div className="max-w-3xl">
        ...
        <h1 className="text-[24px] font-semibold tracking-tight text-gray-900 mb-1">
          {language === "de" ? "Regulatorische Updates" : "Regulatory Updates"}
        </h1>
        <p className="text-[13px] text-gray-500 mb-10">
          {language === "de"
            ? "Kuratierte Änderungen und Neuigkeiten aus dem europäischen Weltraumrecht."
            : "Curated changes and developments in European space law."}
        </p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-[12px] text-gray-300 mt-1">
              {language === "de"
                ? "Updates erscheinen hier sobald regulatorische Änderungen erkannt und verifiziert werden."
                : "Updates will appear here as regulatory changes are detected and verified."}
            </p>
          </div>
        ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <span
                            className={`text-[9px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded border ${cat.color}`}
                          >
                            {cat.label}
                          </span>
                          {update.jurisdiction && (
