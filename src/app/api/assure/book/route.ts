...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      await sendEmail({
        to: email,
        subject: "Your Caelex Assure call is booked — we'll be in touch",
        html: `
            ...
            <div style="padding: 32px 0;">
              ...
              <div style="background: #f8faf9; border-radius: 12px; padding: 20px; border: 1px solid #e5ebe8;">
                ...
                <ol style="margin: 0; padding: 0 0 0 20px; line-height: 1.8; color: #555;">
                  ...
                  <li>You complete onboarding in under 30 minutes</li>
    ...
    try {
      await sendEmail({
        to: "cs@caelex.eu",
        subject: `New Assure Call Booking: ${escapeHtml(name)} — ${escapeHtml(company)}`,
        html: `
