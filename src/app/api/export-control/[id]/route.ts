...
const GONE_BODY = {
  error: "gone",
  message:
    "The legacy export-control assessment API has been retired in Sprint T5 (2026-05-21). Use Caelex Trade at /trade/program (UI) or /api/v1/compliance (programmatic).",
