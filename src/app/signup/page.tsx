        ...
        <div className="max-w-[400px] w-full">
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full border border-[#E5E7EB] hover:border-[#D1D5DB] bg-white hover:bg-[#F1F3F5] text-[#111827] py-3 rounded-lg text-body-lg transition-all duration-200 flex items-center justify-center gap-2.5"
            >
