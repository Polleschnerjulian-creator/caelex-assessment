    ...
    >
      <div className="grid md:grid-cols-2 min-h-[600px] md:min-h-[80vh]">
        ...
        <motion.div
          ...
          className="bg-emerald-50 dark:bg-emerald-950/20 border-b md:border-b-0 md:border-r border-slate-200 dark:border-white/[0.06] p-8 md:p-12 lg:p-16 flex flex-col justify-center"
        >
          ...
          <div className="space-y-4">
            {operatorData.map((item) => (
              <div
                key={item.label}
                className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-white/[0.04]"
              >
                <span className="text-body text-slate-500 dark:text-white/50">
                  {item.label}
                </span>
                <span
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#0A0F1E] p-8 md:p-12 lg:p-16 flex flex-col justify-center"
        >
          <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-slate-400 dark:text-white/40 mb-6">
            ...
            {redactedData.map((item) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="font-mono text-body text-slate-300 dark:text-white/20">
                    {item.value}
                  </span>
      ...
      <div className="border-t border-slate-200 dark:border-white/[0.06] py-8">
        <p className="text-center text-body-lg text-slate-400 dark:text-white/40 italic">
