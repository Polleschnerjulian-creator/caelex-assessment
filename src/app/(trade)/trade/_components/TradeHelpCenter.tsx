...
interface GlossaryEntry {
  term: string;
  definition: string;
  /** Optional category for quick scanning. */
  category?: string;
}

// Curated top compliance terms operators will Google otherwise. Order
// is alphabetical so even un-searched scanning finds known terms fast.
