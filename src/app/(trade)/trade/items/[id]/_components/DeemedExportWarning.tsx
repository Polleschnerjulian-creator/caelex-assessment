...
const LEVEL_STYLES = {
  awareness: {
    wrapper: "rounded-md border border-amber-200 bg-amber-50 p-4",
    iconColor: "text-amber-600",
    headlineColor: "text-amber-900",
    bodyColor: "text-amber-800",
    guidanceColor: "text-amber-800",
    disclaimerColor: "text-amber-700",
    bullet: "text-amber-500",
  },
  action: {
    wrapper: "rounded-md border border-red-200 bg-red-50 p-4",
    iconColor: "text-red-600",
    headlineColor: "text-red-900",
    bodyColor: "text-red-800",
    guidanceColor: "text-red-800",
    disclaimerColor: "text-red-700",
    bullet: "text-red-500",
  },
