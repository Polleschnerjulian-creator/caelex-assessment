...
export default function InsurancePage() {
  ...
  return (
    <div className="min-h-screen bg-[#030711] text-white p-6">
          ...
          <div className="flex items-center gap-3">
            {assessments.length > 0 && (
              <select
                ...
                className="bg-white/[0.04] border border-white/10 rounded-lg px-4 py-2 text-white text-sm"
              >
                {assessments.map((a) => (
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${
                    isActive
                      ...
                      : isCompleted
                        ...
                        : "bg-white/[0.04] text-white/70 border border-white/10 hover:border-white/10"
                  }`}
                >
                  <StepIcon className="w-4 h-4" />
                  {step.name}
                  {index < STEPS.length - 1 && (
                    <ChevronRight className="w-4 h-4 ml-2 text-white/60" />
                  )}
                </button>
              );
            })}
        ...
        <AnimatePresence mode="wait">
          {!selectedAssessment ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="bg-white/[0.04] border border-white/10 rounded-xl p-12 text-center"
            >
              ...
              <button
                onClick={() => setShowNewAssessment(true)}
                className="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 rounded-lg text-white font-medium transition-colors"
              >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-white/[0.04] border border-white/10 rounded-lg px-4 py-2 text-white"
                        >
                ...
                >
                  ...
                  <div className="flex justify-between">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-white/[0.05] hover:bg-white/[0.1] rounded-lg text-white font-medium transition-colors"
                    >
                ...
                >
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <select
                                ...
                                className={`bg-white/[0.04] border rounded-lg px-3 py-1.5 text-sm ${
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            <div>
                              <p className="text-white/70">Coverage Amount</p>
                              <input
                                type="number"
                                ...
                                className="w-full bg-white/[0.04] border border-white/10 rounded px-2 py-1 mt-1"
                              />
                            </div>
                            <div>
                              <p className="text-white/70">Premium</p>
                              <input
                                type="number"
                            ...
                            <div>
                              <p className="text-white/70">Insurer</p>
                              <input
                                type="text"
                            ...
                            <div>
                              ...
                              <input
                                type="date"
                                value={
                                  policy.expirationDate?.split("T")[0] || ""
                                }
                                onChange={(e) =>
                                  updatePolicyStatus(policy.insuranceType, {
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      ...
                      disabled={isSaving}
                      className="flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 disabled:opacity-50 rounded-lg text-white font-medium transition-colors"
                    >
                    ...
                    <>
                      ...
                      <div className="bg-white/[0.04] border border-white/10 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            <p className="text-white/70">Jurisdiction</p>
                            <p className="font-medium">
                              {report.organizationProfile.jurisdictionName}
                            </p>
                          </div>
                          <div>
                            <p className="text-white/70">Operator Type</p>
                            <p className="font-medium">
                      ...
                      <div className="bg-white/[0.04] border border-white/10 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-sm text-white/70">Missing</p>
                          </div>
                        </div>
                      </div>
          ...
          {showNewAssessment && (
            ...
            >
              <motion.div
                ...
                className="bg-[#0F1629] border border-white/[0.1] rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto"
              ...
              >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          primaryJurisdiction: e.target
                            .value as JurisdictionCode,
                        })
                      }
                      className="w-full bg-white/[0.04] border border-white/10 rounded-lg px-4 py-2 text-white"
                    >
                ...
                <div className="flex justify-end gap-3 mt-6">
                  <button
                    onClick={() => setShowNewAssessment(false)}
                    className="px-4 py-2 bg-white/[0.05] hover:bg-white/[0.1] rounded-lg text-white"
                  >
                    Cancel
                  </button>
                  <button
