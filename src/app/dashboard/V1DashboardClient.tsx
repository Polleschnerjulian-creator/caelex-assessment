...
// ─── Main Export ───
// Renamed from `DashboardPage` to `V1DashboardClient` when V2 became
// the default. Imported by src/app/dashboard/page.tsx (server) which
// handles the V2-redirect first, then falls through to this for V1.
