  ...
  return (
    <div className="min-h-screen p-6 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr_360px] gap-6">
        {/* ── Left Panel: Input ──────────────────────────────── */}
        <div className="border border-[var(--border-default)] rounded-xl p-4 overflow-y-auto max-h-[calc(100vh-140px)]">
          <InputPanel
        ...
        <div className="border border-[var(--border-default)] rounded-xl p-4 min-h-[500px] flex flex-col">
          {/* Error state */}
          {error && (
            <div className="mb-4 border border-[var(--accent-danger)/30] rounded-lg p-3 flex items-start gap-2">
              <span className="text-[var(--accent-danger)] text-xs shrink-0 mt-0.5">
                &#9888;
              </span>
          ...
          {!result && !isLoading && !error && (
            <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
              <div className="text-[var(--text-secondary)] text-4xl mb-4">
                &#9881;
              </div>
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-md text-xs border transition-all duration-200 ${
                    activeTab === "rankings"
                      ...
                      : "border-[var(--border-default)] text-[var(--text-tertiary)] hover:border-[var(--border-default)]"
                  }`}
                >
                  Rankings
                </button>
