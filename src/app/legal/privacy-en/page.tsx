        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="prose prose-sm max-w-none space-y-10">
            ...
            <section>
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] text-body-lg text-[#4B5563]">
                <p>
                  <strong className="text-[#4B5563]">Caelex</strong>
                  <br />
                  Julian Polleschner
                  <br />
                  Am Maselakepark 37
              ...
              <div className="mt-4 p-4 bg-emerald-500/10 rounded-lg border border-emerald-500/20">
                <p className="text-body text-[#111827] font-medium mb-2">
                  Your Rights at a Glance
                </p>
                <ul className="text-body text-[#4B5563] space-y-1">
            ...
            <section>
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Legal basis:</strong> Art.
                6(1)(f) GDPR (legitimate interest in website security and
                stability).
                <br />
                <strong className="text-[#4B5563]">Retention:</strong> 14 days,
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                ...
                <br />
                <strong className="text-[#4B5563]">Retention:</strong> Until
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                ...
                (legitimate interest).
                <br />
                <strong className="text-[#4B5563]">Retention:</strong> 3 years
            ...
            <section>
              ...
              {/* Hosting */}
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                <h4 className="text-body-lg font-medium text-[#111827] mb-2">
                  Vercel Inc. — Hosting & CDN
                </h4>
                <p className="text-body text-[#4B5563]">
                  440 N Barranca Ave #4133, Covina, CA 91723, USA
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong> Website
                  hosting, content delivery, edge functions
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> IP
                  addresses, request data, logs
                  <br />
                  <strong className="text-[#4B5563]">Safeguards:</strong> EU-US
                  ...
                  <a
                    ...
                    className="text-[#111827] hover:text-[#111827] text-small"
                  >
                    Privacy Policy →
                  </a>
                </p>
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong>{" "}
                  PostgreSQL database for all application data
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> All data
                  stored in the platform (encrypted)
                  <br />
                  <strong className="text-[#4B5563]">Safeguards:</strong> SOC 2
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong> Payment
                  processing, subscription management
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Email, name,
                  payment information, billing address
                  <br />
                  <strong className="text-[#4B5563]">Safeguards:</strong> PCI
                  DSS Level 1, EU-US DPF, SCCs
                  <br />
                  <a
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Email
                  addresses, email content, open rates
                  <br />
                  <strong className="text-[#4B5563]">Safeguards:</strong> SCCs
                  <br />
                  <a
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong> Storage
                  of uploaded documents
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Uploaded
                  files, metadata
                  <br />
                  <strong className="text-[#4B5563]">Safeguards:</strong> ISO
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong> Error
                  detection, performance monitoring (consent required)
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Error
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB]">
                ...
                <p className="text-body text-[#4B5563]">
                  <strong className="text-[#4B5563]">Purpose:</strong> Anonymous
                  usage statistics (consent required)
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Aggregated,
                  anonymized page views
                  <br />
                  <strong className="text-[#4B5563]">Cookies:</strong> None
                  (cookieless)
                  <br />
                  <a
              ...
              {/* AI Service */}
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mt-4">
                <h4 className="text-body-lg font-medium text-[#111827] mb-2">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Purpose:</strong>{" "}
                  AI-powered compliance assistant (ASTRA) — answering questions
                  about regulatory requirements
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> User text
                  ...
                  training purposes)
                  <br />
                  <strong className="text-[#4B5563]">Note:</strong> Use of ASTRA
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mt-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  metrics
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Signup
                  events (masked email address), subscription events, compliance
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mt-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Data:</strong> Sanitized IP
            ...
            <section>
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Important:</strong> ASTRA
                does not make legally binding decisions. All outputs are
                intended as support and do not replace legal advice.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-body-lg text-[#4B5563] mt-3 space-y-2">
                <li>
                  <strong className="text-[#4B5563]">
                ...
                <li>
                  <strong className="text-[#4B5563]">Documentation:</strong> All
