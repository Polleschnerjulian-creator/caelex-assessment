          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-10">
            ...
            <section>
              ...
              <p className="text-body-lg text-white/45 leading-relaxed mt-3">
                <strong className="text-white/70">Legal basis:</strong> Art.
                6(1)(f) GDPR (legitimate interest in website security and
                stability).
                <br />
                <strong className="text-white/70">Retention:</strong> 14 days,
              ...
              <p className="text-body-lg text-white/45 leading-relaxed mt-3">
                ...
                <br />
                <strong className="text-white/70">Retention:</strong> Until
              ...
              <p className="text-body-lg text-white/45 leading-relaxed mt-3">
                ...
                (legitimate interest).
                <br />
                <strong className="text-white/70">Retention:</strong> 3 years
            ...
            <section>
              ...
              <p className="text-body-lg text-white/45 leading-relaxed mt-3">
                <strong className="text-white/70">Important:</strong> ASTRA does
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-body-lg text-white/45 mt-3 space-y-2">
                ...
                <li>
                  <strong className="text-white/70">Documentation:</strong> All
