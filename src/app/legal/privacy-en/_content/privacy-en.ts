      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Aggregate product metrics with no personal reference (FeatureUsageDaily, CustomerHealthScore, AnalyticsFunnelDaily, AnalyticsRetentionCohort, AnalyticsPathEdge): per-day or per-week pseudonymity-preserving count, funnel, path and retention rollups with no user id, stored with path-normalised, personally-non-identifying keys; retained for up to 24 months for year-over-year trend and retention analysis, then deleted.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Cloudflare Inc. (R2 object storage for documents and attachments, EU region)",
            "Stripe Payments Europe Ltd. (payments, Ireland)",
            "Resend Inc. (transactional email)",
            "Sentry / Functional Software Inc. (error monitoring with PII scrubbing)",
            "Vercel Inc. (Web Analytics — cookieless, only on consent)",
            "Vercel Inc. (Speed Insights — Core Web Vitals, only on consent)",
            "LogSnag (server-side business-event monitoring, Canada)",
