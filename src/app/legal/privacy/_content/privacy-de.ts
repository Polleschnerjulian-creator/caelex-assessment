      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Aggregierte Produkt-Kennzahlen ohne Personenbezug (FeatureUsageDaily, CustomerHealthScore, AnalyticsFunnelDaily, AnalyticsRetentionCohort, AnalyticsPathEdge): tages- bzw. wochen-bezogene, pseudonymitäts-erhaltende Zähl-, Funnel-, Pfad- und Retentions-Rollups ohne User-ID, gespeichert mit pfad-normalisierten, personenbezugsfreien Schlüsseln; aufbewahrt für bis zu 24 Monate für Jahres-Trend- und Retentionsanalysen, danach Löschung.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Cloudflare Inc. (R2 Objektspeicher für Dokumente und Anhänge, EU-Region)",
            ...
            "Vercel Inc. (Web Analytics — cookielos, nur mit Einwilligung)",
            "Vercel Inc. (Speed Insights — Core Web Vitals, nur mit Einwilligung)",
            "LogSnag (server-seitiges Geschäftsereignis-Monitoring, Kanada)",
