          ...
          <div className="prose prose-sm max-w-none space-y-10">
            ...
            <section>
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Rechtsgrundlage:</strong>{" "}
                Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der
                Sicherheit und Stabilität der Website).
                <br />
                <strong className="text-[#4B5563]">Speicherdauer:</strong> 14
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                ...
                <br />
                <strong className="text-[#4B5563]">Speicherdauer:</strong> Bis
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Rechtsgrundlage:</strong>{" "}
                Art. 6 Abs. 1 lit. b DSGVO (vorvertragliche Maßnahmen) oder Art.
                6 Abs. 1 lit. f DSGVO (berechtigtes Interesse).
                <br />
                <strong className="text-[#4B5563]">Speicherdauer:</strong> 3
            ...
            <section>
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Zweck:</strong>{" "}
                  Website-Hosting, Content Delivery, Edge Functions
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong>{" "}
                  IP-Adressen, Request-Daten, Logs
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> EU-US
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong> Alle in der
                  Plattform gespeicherten Daten (verschlüsselt)
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> SOC 2
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Zweck:</strong>{" "}
                  Verarbeitung von Zahlungen, Abonnementverwaltung
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong> E-Mail,
                  Name, Zahlungsinformationen, Rechnungsadresse
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> PCI DSS
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> SCCs
                  <br />
                  <a
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mb-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Zweck:</strong> Speicherung
                  von hochgeladenen Dokumenten
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong>{" "}
                  Hochgeladene Dateien, Metadaten
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> ISO
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB]">
                ...
                <p className="text-body text-[#4B5563]">
                  <strong className="text-[#4B5563]">Zweck:</strong> Anonyme
                  Nutzungsstatistiken (nur mit Einwilligung)
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong>{" "}
                  Aggregierte, anonymisierte Seitenaufrufe
                  <br />
                  <strong className="text-[#4B5563]">Cookies:</strong> Keine
                  (cookieless)
                  <br />
                  <a
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mt-4">
                ...
                <p className="text-body text-[#4B5563]">
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong>{" "}
                  Textanfragen der Nutzer, Kontext aus Compliance-Modulen (keine
                  ...
                  <br />
                  <strong className="text-[#4B5563]">Hinweis:</strong> Die
              ...
              <div className="p-4 bg-white rounded-lg border border-[#E5E7EB] mt-4">
                ...
                <p className="text-body text-[#4B5563]">
                  San Francisco, CA, USA
                  <br />
                  <strong className="text-[#4B5563]">Zweck:</strong> Verteiltes
                  Rate Limiting zum Schutz vor Missbrauch
                  <br />
                  <strong className="text-[#4B5563]">Daten:</strong>{" "}
                  Sanitisierte IP-Adress-Hashes, API-Endpunkt-Pfade
                  <br />
                  <strong className="text-[#4B5563]">Garantien:</strong> SOC 2,
            ...
            <section>
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Wichtig:</strong> ASTRA
                trifft keine rechtlich bindenden Entscheidungen. Alle Ausgaben
                sind als Unterstützung zu verstehen und ersetzen keine
                Rechtsberatung.
              </p>
              ...
              <p className="text-body-lg text-[#4B5563] leading-relaxed mt-3">
                <strong className="text-[#4B5563]">Rechtsgrundlage:</strong>{" "}
                Art. 6 Abs. 1 lit. b DSGVO. Es findet keine automatisierte
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-body-lg text-[#4B5563] mt-3 space-y-2">
                ...
                <li>
                  <strong className="text-[#4B5563]">Dokumentation:</strong>{" "}
                  Alle Vorfälle werden dokumentiert, einschließlich Ursache,
