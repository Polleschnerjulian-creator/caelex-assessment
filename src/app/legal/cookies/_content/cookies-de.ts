  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "C. Analyse (nur mit Einwilligung, soweit aktiviert):",
        },
        {
          type: "ul",
          items: [
