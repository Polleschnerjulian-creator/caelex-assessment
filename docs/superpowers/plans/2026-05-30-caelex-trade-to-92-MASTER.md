...
| --------------------------- | -------------- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A — Screening hardening     | 🟡 6 of 8 done | see `git log` feat/fix(trade) | A1✅ token-set · A2✅ **T-H2** name-order · A3✅ identifier type+value · A4✅ **T-H3** fail-closed · A5✅ **T-M12** missingLists · A6✅ **T-H5** sanctioned control-without-equity escalates. 306 screening tests green, all review-gated, NO migration (existing enums). NEXT: A7 OFAC alt.csv aliases (**T-H4**, parser+free treasury.gov data) → A8 cross-screen UBO dedup (**T-M2**). |
