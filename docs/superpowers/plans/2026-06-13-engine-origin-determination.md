...
| ------------------------------------------------------------------------- | ------ | ------- | ------------------------------------------------------------------------------------- |
| F — Foundation (interface + registry + wiring + US-wrap + golden-harness) | ⬜     | —       | —                                                                                     |
| M-EU — EU module (EUGEA + member→NCA)                                     | ⬜     | —       | maturity EU_ANNEX_I already 2; EU_CML already 2 — module adds licence detail, no lift |
| M-UK — UK module (OGELs/ECJU)                                             | ⬜     | —       | lift UK_STRATEGIC 3→2                                                                 |
| M-CH — Switzerland (GAB/SECO)                                             | ⬜     | —       | lift CH_GKV 3→2                                                                       |
