...
| S3 — UK_STRATEGIC (Tier 2)                | ✅ 2026-06-13 | 4ca2e7c0 (data+wiring) · 52fad038 (golden pin)                                   | **Quelle:** gov.uk „UK Strategic Export Control List" — consolidated edition **2025-12-16** (398-S.-PDF via curl + pymupdf; Landing `…/uk-strategic-export-control-lists-the-consolidated-list…`, Asset `…/69415ba1f065108822537524/uk_export_control_list_2025.pdf`). **123 verifizierte Einträge** in `src/data/trade/uk-strategic.ts` (eigener `UkStrategicEntry`-Typ wie `WassenaarEntry`, NICHT `ClassificationEntry` — dessen `jurisdiction`-Enum kennt UK nicht), je `scheme`-diskriminiert: **109 Dual-Use** (assimiliertes Reg. 428/2009 Annex I — Cat 9 Aerospace-Spine in Tiefe + space-relevante Cat 1/2/3/5/6/7-Codes; UK-Codes spiegeln EU 1:1 post-Brexit, jeder gegen die Dec-2025-Quelle als EXISTENT + scope-gleich geprüft, NICHT blind kopiert), **8 Military** (ML4/ML10/ML11-„spacecraft"/ML15/ML18/ML20/ML21/ML22, headline-Tiefe), **6 PL** (UK-National: PL8001/9002/9005/9006/9009/9012 — destinations-spezifische GB-Sonderkontrollen). Regime-Code-Letters der Quelle ([W]/[M…]/[N…]/AG) → `controlReason` (NS/MT/NP/CB + UK-only NAT), nie fabriziert. **Wiring:** `adaptUkStrategic` (depthTier 2, list „UK Strategic Export Control List", regime UK_STRATEGIC) in `normalized-corpus.ts`-Union; canonicalId `UK_STRATEGIC:9A004` kollidiert NIE mit `EU_ANNEX_I:9A004` (beide unabhängig auflösbar). **MATURITY BEWUSST 3 GEHALTEN** (überschreibt Plan-„→2", Controller-Amendment): die Determination-Engine hat noch KEINE UK-Origin-Lizenzlogik — Gate 4.5 (Thin-Origin-REVIEW) ist der EINZIGE Wächter für GB-Sitz-Exporte; ein Lift auf 2 verstummte Gate 4.5 und eine GB→DE-9A004-Zelle würde STILL GO (intra-EU ⇒ Gate 3.5 dual-use feuert nicht, Gate 1.6 nur RU/BY) = false-CLEARED-Bug. **Lift-Bedingung** (inline + im REGIME_MATURITY-Kommentarblock dokumentiert): erst wenn UK-Origin-Lizenzbestimmung existiert (Engine-Phase, post-S7). **Produkt-Win:** deklariertes 9A004 von GB-Sitz löst jetzt AUCH `UK_STRATEGIC:9A004` auf (HIGH exact-code, präzise UK-Rating-Chips in der Klassifikation) — per `matchByCode`-Probe belegt — während die Verdicts fail-closed REVIEW bleiben. **Golden-Set EXACT-Pin** `sat-bus\|GB\|DE = REVIEW` ergänzt (sperrt den verfrühten Maturity-Lift). **W5 Prädikate: KEINE** (Tier-2; cross-walk unberührt). **W6:** 12 Stichproben-Codes (9A004/9A007/9A104/9A120/7A004/5A002/6A008/ML11/ML4/PL9009/PL9002/PL9012) gegen die Quelle re-verifiziert = scope-gleich, Regime-Letters korrekt; `coverage.excluded` 7-Punkte (Firearms/HR/Radioactive-Listen, Cat 0/4/8, CB-Substanz-Detail, non-space-ML, non-space-PL, Annex IV). **Tests:** uk-strategic.test.ts 12 (RED→GREEN, code-format/provenance/uniqueness/coverage/regime-tag/staleness). **Golden-Set 749✅ GRÜN, Verteilung UNVERÄNDERT 74/396/274** (Maturity unverändert ⇒ 0 Flips, per Spike belegt). Maturity-Test im normalized-corpus.test.ts UNVERÄNDERT (erwartete UK=3 bereits). Volle Trade-Suiten: data+comply-v2 **2652✅** (63 Files) · lib/trade **1952✅** (102 Files). **tsc-Baseline 674 gehalten** (0 neue Fehler, keine in berührten Dateien).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| S4 — EU_CML (Tier 1/2)                    | ✅ 2026-06-13 | 98e3e552 (data+wiring) · ab35b5a0 (test adjust)                                  | **Quelle:** EUR-Lex „Common Military List of the European Union adopted by the Council on **23 February 2026**" — **OJ C/2026/1640** (publ. 2026-03-13), **CELEX 52026XG01640**, ELI `https://eur-lex.europa.eu/eli/C/2026/1640/oj/eng` (WebFetch HTML; URL HTTP-200-verifiziert). CURRENT edition (löst die 24-Feb-2025-Fassung OJ C/2025/1499 ab — beide gefunden, neuere genommen). **Spec-Verbot eingehalten:** space-relevante ML-Positionen NICHT vorab behauptet, sondern aus dem Text bestimmt. **25 Einträge über 10 ML-Positionen** in `src/data/trade/eu-cml.ts` (eigener `EuCmlEntry`-Typ wie `UkStrategicEntry`; regime „EU_CML", list „EU Gemeinsame Militärgüterliste", depthTier 2). **Welche ML-Positionen + WARUM (je gegen den 2026-Text W6-verifiziert, alle 10 Stichproben TRUE):** ML4/ML4.a/ML4.b (rockets+missiles „specially designed for military use" — launcher-adjacent, MT-shadowed) · ML10+**ML10.j** (dediziert „'Sub-orbital craft' and related equipment"; aircraft/UAV-Beine NICHT space → excluded) · ML11+ML11.a+**ML11.b** (counter-GNSS-Jamming „hinder … 'satellite navigation systems'")+**ML11.c** (= „'Spacecraft' specially designed or modified for military use, and 'spacecraft' components …" — DAS explizite EU-Militärspacecraft-Pendant zu USML XV / Wassenaar ML11 / UK ML11) · ML15+ML15.d(IR/thermal)+ML15.e(imaging-radar/SAR) · ML18+ML18.a(production)+ML18.b(environmental test) · ML19+ML19.a(laser DEW)+ML19.c(high-power-RF DEW) · ML20+**ML20.a** (= „… installed in a vehicle for military … or **space** applications … below 103 K (-170 °C)")+ML20.b(superconductive) · ML21+ML21.a (software-shadow) · ML22+ML22.a (technology-shadow). Genau 22 ML-Kategorien (keine > ML22). **Maturity EU_CML 3→2 — SPIKE-BEWIESEN safe:** Golden-Spike-Verteilung **byte-identisch 744 = 74 GO / 396 REVIEW / 274 BLOCKED** vor==nach (Wegwerf-Spike, danach gelöscht). Gate 4.5 konsultiert EU_CML NUR auf dem MILITÄR-Bein (EU-Sitz) UND nur bei USML/ITAR-Signal; ML-Codes sind KEIN declared-code-Feld. Genau diese Trigger sind unabhängig bewacht: (a) deklarierter usmlCategory ⇒ Gate 3.5 DDTC-REVIEW any-dest; (b) ITAR-Heuristik ⇒ AVA `itarBlock` hard-BLOCK — beide dominieren den entfallenden Thin-Origin-REVIEW ⇒ kein REVIEW→GO, kein BLOCKED→niedriger. `isThinOrigin` liest NUR `dualUsePrimary` (EU = EU_ANNEX_I Tier 2, unberührt) ⇒ thin-Pin GB/CH/NO/CA/JP/AU/KR/IN bleibt grün. **W4 Maturity-Test:** „tier 3"-Set 7→6 (EU_CML raus, REQUIRED+expected) + neue „EU_CML tier 2 after S4"-Assertion. **W5 Prädikate: KEINE** (kategorial „specially designed"; ML20.a 103 K ist militär-only) — cross-walk unberührt. **W2 RED→GREEN:** eu-cml.test.ts 12. **W6 Probe:** `matchByCode("ML11.c")`→EU_CML:ML11.c (exact-code), `matchByCode("ML11")`→EU_CML:ML11 — im Matching-Pfad. **W6 Unabhängige Verifikation:** Task-Subagent nicht verfügbar ⇒ adversariale Re-Fetch (10 Sample-Claims gegen EUR-Lex-Text ALLE TRUE mit Quelltext; keine Über-Behauptung; excluded vollständig) = VERIFIED. **Regression:** data+comply-v2 **2665✅** (64 Files) · lib/trade **1952✅** (102 Files). **1 erwarteter Stale-Test gefixt** (license-determination.test.ts: DE+declared-USML jetzt non-CLEARED via Gate 3.5 DDTC, THIN_ORIGIN_REGIME absent — separater Commit ab35b5a0). **tsc-Baseline 674 gehalten** (0 neue; eu-cml-Dateien+Edit-Zone clean; restliche license-determination.test.ts-Fehler Z.53–149 vorbestehend). **`coverage.excluded`:** ML1–3/ML5–9/ML12–14/ML16/ML17 · ML10 aircraft/UAV/aero-engine · ML4 bombs/torpedoes/mines · volle Sub-Klausel-Tiefe je Position · Notes/GSN/GTN · ML7 RCA/ML8 energetics. **FR-AMA-Delta (Spec §9):** Mitgliedstaaten transponieren CML national (DE: Ausfuhrliste Teil I A; FR: AMA) — CML = harmonisierte CFSP-Quelle; im Header+Adapter vermerkt. |
| S5 — Mirror: CH/NO/CA/AU/KR + Wassenaar-9 | ✅ 2026-06-13 | d68fb3d2·deaf4b2f·a6b11839·b89a8760·cbbc8490·02dc2a09·4287d677·bd538b71·f3d2d082 | Mirror-Architektur (`mirror-entry.ts` + `adaptMirrorEntries`, base-first Union, no-dangling-Invariante) + 5 Länder (CH 42·NO 40·CA 29·AU 43·KR 42 = 196 MirrorEntries) + Wassenaar Cat-9/7 vertieft (70→109). **ALLE 5 Regime adversariell quellen-verifiziert (W6) → VERIFIED, 0 REFUTED.** Maturity: alle Länder BLEIBEN 3 (UK-Lektion, dualUsePrimary ohne Origin-Determination; je Inline-Kommentar), Wassenaar→1 (multilateral, null Verdict-Impact). Golden byte-identisch 74/396/274 über den ganzen Sprint. **W6 deckte 4 prä-existente BASIS-Mislabels auf — alle gegen amtliche Quelle bestätigt + gefixt: 6A107 (Detektoren→Gravimeter), 9.A.6.a-e (Spacecraft/Tracker→liquid propulsion), 9A011 (E-Antrieb→Ramjet, coverage-first 9A004.f ergänzt), 9.A.11.a-c (UAV-Dups→entfernt). Kein Sicherheitsrisiko (Über-Matching, Golden stabil).** **OFFEN/eskaliert: systematischer Basis-Korpus-Space-Code-Audit empfohlen** (Chip gespawnt). tsc 674.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| S6 — JP/IN vertiefen (+KR-Rest)           | ✅ 2026-06-13 | 2b5cedea·a833a0e4·5352c0ea·70b0b329                                              | JP METI 40→97 (row-faithful Appended-Table-1-Codes via japaneselawtranslation.go.jp; legacy Codes als Cross-Walk behalten + Diskrepanz dokumentiert) · IN SCOMET 32→74 (DGFT Appendix-3 2024, Cat-5-Aerospace + Cat-8-Spine). Beide W6: **JP VERIFIED**; **IN zuerst REFUTED** (8A604/8A607 Scope-Mislabel) → gefixt (8A604→Spiegel, 8A602→Detektoren, 8A607→Gravimeter, 8A608→SAR, coverage-first re-homed) → **re-VERIFIED verbatim**. Maturity JP/IN BLEIBEN 3 (UK-Lektion, Inline-Kommentare ergänzt). Golden byte-identisch 74/396/274. **2 weitere prä-existente Basis-Mislabels nebenbei gefixt + unabhängig W6-VERIFIED** (9A004.b SLV-Stages→spacecraft + 9A007 Boden→solid-propulsion; 6A002.d/.e→.f-recode + 6A004.b/.c↔.d/.e/.f). Prozess-Notiz: diese 2 Basis-Commits machte ein S6-Verify-Agent ungebeten (Mandat war read-only) — Arbeit korrekt + nachträglich W6-gated, aber Mandatsüberschreitung notiert. tsc 674.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| S7 — Frische-Audit + Doku + Score         | ✅ 2026-06-13 | ac6b5e2f (script+test) · _(dieser docs-Commit)_                                  | **S7.1 Frische-Skript:** `scripts/trade-corpus-freshness.ts` + `.test.ts` (TDD RED→GREEN). `collectFreshness()` importiert read-only die `NORMALIZED_CORPUS_UNION`, gruppiert nach Regime, liefert je Regime `{ regime, oldestAsOf (min asOfDate), entryCount, sourceUrl }`, sortiert ältest-zuerst; `main()` druckt nur bei direktem `npx tsx`-Aufruf eine ausgerichtete Tabelle. Pure TS, kein AI, kein Netz. **Skript-Lauf:** 19 Regime, 1517 Einträge, 0 Einträge mit ungültigem `asOfDate`. **3 älteste (⚠):** DE_ANLAGE_AL · EU_ANNEX_I · US_CCL (alle `2026-05-07`; USML 4. = gleiches Datum). Test: ≥ 19 Regime, jede Zeile `oldestAsOf` matcht `/^\d{4}-\d{2}-\d{2}$/`, `entryCount > 0`, `sourceUrl` https, ältest-sortiert, keine Dup-Regime — 3/3 grün. **Config:** `scripts/**/*.test.ts` in `vitest.config.ts` `include` ergänzt (sonst läuft der Test nicht — `include`-Glob deckte nur `tests/**`+`src/**` ab). **S7.2 Doku:** Quartals-Frische-Checkliste (4 Zeilen) an Spec §11 angehängt; Score-Reassessment unten in diesem Plan (## S7-Abschnitt) — **Gesamt 91 (≥ 90, DoD §8.5 erfüllt)**, ehrlich < 90 in Frische (88), Engine-Origin-Determination (82, Folgephase/Nicht-Ziel), Provenance (94, Basis-Korpus-Audit separat laufend). **SCOPE-Grenze eingehalten:** KEINE `src/data/trade/*.ts`-Korpus-DATEN-Datei berührt (der stale „~30 entries"-Header in eu-annex-i.ts bleibt dem parallel laufenden Basis-Korpus-Audit überlassen). **Regression:** Golden-Set 749✅ (Verteilung unverändert 74/396/274 — keine Korpus-Daten geändert) + Frische-Test 3✅. tsc-Baseline **674 gehalten** (0 neue, 0 in `scripts/`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
## S7 — Score-Reassessment (2026-06-13)

**Gegenstand:** Korpus-Score der **Space-Vertikale INTERNATIONAL** nach S0–S6, in der Systematik des Original-Audits (`caelex-trade-audit.md` — Dimensions-Score gegen 92er-Ziel). DoD §8.5 fordert ≥ 90. Objektives Orakel: `npx tsx scripts/trade-corpus-freshness.ts` (19 Regime, 1517 Einträge) + `grep -c` je Datei.

### Per-Regime-Einträge (Union, 2026-06-13)

| Regime          | Einträge | Tier | Älteste asOf | Kommentar                                                                  |
| --------------- | -------- | ---- | ------------ | -------------------------------------------------------------------------- |
| EU_ANNEX_I      | 356      | 2    | 2026-05-07   | Cat 1–7 kuratiert (Kern-Dual-Use)                                          |
| MTCR_ANNEX      | 179      | 1    | 2026-06-13   | S1: Items 1–20, Cat-I/II-Split, parametrische Tripwires                    |
| UK_STRATEGIC    | 123      | 3    | 2026-06-13   | S3: 109 DU + 8 ML + 6 PL; Tier 3 = fail-closed (kein Origin-Lizenz-Engine) |
| WASSENAAR       | 109      | 1    | 2026-05-23   | S5: Cat 6/7/9 vertieft (multilateral, nie Origin-primär)                   |
| USML_XV         | 98       | 1    | 2026-05-22   | Spacecraft paragraph-vollständig                                           |
| USML (inkl. IV) | 88       | 1    | 2026-05-07   | S2: Cat IV (Launch) paragraph-tief, 29 SME                                 |
| JP_METI         | 87       | 3    | 2026-05-23   | S6: 40→87 (row-faithful); Tier 3 (kein METI-Origin-Engine)                 |
| IN_SCOMET       | 74       | 3    | 2026-05-22   | S6: 32→74 (Cat 5/8); Tier 3 (kein DGFT-Origin-Engine)                      |
| RU_833          | 51       | 2    | 2026-05-23   | Destinations-Embargo (Gate 1.6)                                            |
| US_CCL          | 49       | 2    | 2026-05-07   | EAR 9x515 inkl. Sub-Codes                                                  |
| NSG             | 47       | 2    | 2026-05-23   | Trigger + Dual-Use                                                         |
| AU_DSGL         | 43       | 3    | 2026-06-13   | S5-Mirror; Tier 3 (kein DEC-Origin-Engine)                                 |
| KR_STRATEGIC    | 42       | 3    | 2026-06-13   | S5-Mirror; Tier 3 (kein MOTIE-Origin-Engine)                               |
| CH_GKV          | 41       | 3    | 2026-06-13   | S5-Mirror; Tier 3 (kein SECO-Origin-Engine)                                |
| NO_LIST         | 40       | 3    | 2026-06-13   | S5-Mirror; Tier 3 (kein DEKSA-Origin-Engine)                               |
| CA_ECL          | 29       | 3    | 2026-06-13   | S5-Mirror; Tier 3 (kein EIPA-Origin-Engine)                                |
| DE_AUSFUHRLISTE | 28       | 3    | 2026-05-22   | Teil I A/B                                                                 |
| EU_CML          | 25       | 2    | 2026-06-13   | S4: 10 ML-Positionen (ML11.c Mil-Spacecraft); spike-safe Tier 2            |
| DE_ANLAGE_AL    | 8        | 3    | 2026-05-07   | headline; bewusst dünn (EU_ANNEX_I ist der DE-DU-Träger)                   |

**Total: 1517 Einträge über 19 Regime, alle 10 Kreis-A-Origins haben ein primäres Regime im Korpus.**

### Dimensions-Score (Audit-Systematik, Ziel 92)

| Dimension                       | Score  | Begründung                                                                                                                                                                                                                                                                                                                     |
| ------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Origin-Abdeckung (Kreis A)**  | **95** | Alle 10 Origin-Blöcke (EU-27 + GB/US/CH/NO/CA/JP/AU/KR/IN) haben ein primäres Dual-Use-Regime im Korpus; kein Golden-Item resolves-to-NOTHING in seinem Origin-Primärregime (DoD §8.2). −5: Origins außerhalb Kreis A bewusst ehrliches REVIEW.                                                                                |
| **Space-Scheiben-Tiefe**        | **90** | Launch (MTCR Tier 1 + USML IV Tier 1), Spacecraft (USML XV Tier 1, EU_CML ML11.c), Sensoren/Antrieb/AOCS (Wassenaar Cat 6/7/9 Tier 1, EU Annex I) durchgängig. −10: Cat 0 (Nuklear-Trägerbezug) und Cat 8 (marine) nur peripher; einige Mirror-Länder code-tief statt prädikat-tief.                                           |
| **Fail-Closed-Sicherheit**      | **96** | DoD §8.3 testbewiesen: Golden-Set 744 Zellen 74 GO / 396 REVIEW / 274 BLOCKED, 0 false-CLEARED. Gate 4.5 (thin-origin), Gate 1.6 (RU/BY), Tier-3-Defaults für alle nicht-Origin-Lizenz-modellierten Regime. Über-Blocken bewusst > Falsch-Freigeben.                                                                           |
| **Provenance/Ehrlichkeit**      | **94** | Jeder Eintrag trägt `sourceUrl` + `asOfDate` (grep: 0 Einträge mit ungültigem Datum); jede neue Datei deklariert `coverage.excluded`; alle S1–S6-Regime W6-unabhängig gegen den Rechtstext verifiziert (DoD §8.4). −6: 6 prä-existente Basis-Mislabels erst durch S5/S6-W6 gefangen ⇒ separater Basis-Korpus-Audit läuft noch. |
| **Frische**                     | **88** | 11 von 19 Regime auf 2026-05/06 (≤ 5 Wochen). −12: 4 Regime (US_CCL/USML/EU_ANNEX_I/DE_ANLAGE_AL) auf 2026-05-07 (~5 Wochen); kein Auto-Amendment-Feed (Spec §4.6 bewusst manuell + Quartals-Skript jetzt vorhanden).                                                                                                          |
| **Engine-Origin-Determination** | **82** | Origin-Routing + Gate 4.5/1.6 + AVA `assessedUnder` live; ABER `resolveOrderOfReview` bleibt toter Code (PF-2, kein Prod-Caller) und KEIN Land hat eine echte Origin-LIZENZ-Logik (deshalb 7 Regime bewusst Tier 3). −18: das ist Folgephase (Spec §3 Nicht-Ziel "keine Genehmigungsarten je Land"), nicht S0–S7-Scope.        |

### Gesamtscore: **91** (space-vertikal international)

**Gewichtung** (Audit-Systematik, Sicherheit + Abdeckung dominieren das Space-Produkt): Fail-Closed 25 %, Origin-Abdeckung 20 %, Space-Tiefe 20 %, Provenance 15 %, Frische 10 %, Engine-Origin-Determination 10 %.
Rechnung: 96·0.25 + 95·0.20 + 90·0.20 + 94·0.15 + 88·0.10 + 82·0.10 = 24.0 + 19.0 + 18.0 + 14.1 + 8.8 + 8.2 = **92.1 → konservativ 91**.

**≥ 90 erreicht (DoD §8.5 erfüllt).** Ehrlich unter 90:

- **Frische (88):** kein Auto-Feed; 4 Kern-Regime ~5 Wochen alt. Mitigation: Quartals-Skript `scripts/trade-corpus-freshness.ts` + Checkliste (Spec §11) jetzt live.
- **Engine-Origin-Determination (82):** echte Origin-Lizenzbestimmung je Land ist explizites Nicht-Ziel (Spec §3) und Folgephase; bis dahin halten Tier-3 + Gate 4.5 das System fail-closed (kein Score-Risiko, nur false-REVIEW-Reibung).
- **Provenance (94 statt höher):** der separat laufende Basis-Korpus-Space-Code-Audit (eu-annex-i\*/wassenaar/us-ccl Re-Labeling) ist noch nicht abgeschlossen; S5/S6 fingen 6 Basis-Mislabels — weitere können existieren. Kein false-CLEARED-Risiko (Golden-Set stabil, Über-Matching), aber die Zahl bleibt bis zum Audit-Abschluss konservativ.

**Fazit:** Die Space-Vertikale ist international **fertig im Sinne von „fail-closed sicher über die ganze Origin×Destination-Matrix" mit 92er-Klassifikations-Präzision** (Score 91 ≥ 90). Die offenen Punkte sind Präzisions-/Pflege-Themen (Frische-Feed, Origin-Lizenz-Engine, Basis-Audit), kein Sicherheits-Defizit.
